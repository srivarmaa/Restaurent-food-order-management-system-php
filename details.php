    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-maps-local-restaurant"></i> Order Food</a>
            </li>
                <li class="no-padding">
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/details-router.php" novalidate="novalidate"class="col s12">
                      ...
                      <?php 
                        ...
                        $sql = mysqli_query($con, "SELECT * FROM wallet_details WHERE wallet_id = $user_id;");
                        while($row = mysqli_fetch_array($sql)){
                          $number = $row['number'];	
                          $cvv = $row['cvv'];
                        echo '<div class="row">
                        <div class="input-field col s6">
                          ...
                          <input name="number" id="num" type="text" maxlength="16" readonly="readonly" value="'. $number .'" data-error=".errorTxt3">
                        ...
                        <div class="input-field col s6">
                          <i class="mdi-action-credit-card prefix"></i>
                          <input name="cvv" id="num" type="text" maxlength="3" readonly="readonly" value="'. $cvv .'" data-error=".errorTxt3">
                          <label for="email" class="">My Card Number</label>
						  <div class="errorTxt3"></div>
                        </div>
                      </div>';

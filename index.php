...
<body>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="place-order.php" class="waves-effect waves-cyan"><i class="mdi-hardware-keyboard-tab"></i> Wallet</a></li>	
 ...
 <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span> <a class="grey-text text-lighten-4" href="#" target="_blank">SOFTWARE ENGINEERING</a> HOTERL ORDERING APPLICATION</span>
        <span class="right"> TEAM NO 5<a class="grey-text text-lighten-4" href="#"></a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
